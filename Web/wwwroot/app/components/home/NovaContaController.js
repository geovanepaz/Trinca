...
(function ()
{
  ...
  angular
    .module("boilerplate")
    .controller("NovaContaController", NovaContaController);

  NovaContaController.$inject = ["$window", "$scope", "$state", "LocalStorage", "QueryService", "SweetAlert", "CONSTANTS"];

  function NovaContaController($window, $scope, $state, LocalStorage, QueryService, SweetAlert, CONSTANTS)
  {
    // 'controller as'
    var self = this;
