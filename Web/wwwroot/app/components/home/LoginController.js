...
(function ()
{
  ...
  LoginController.$inject = ["$window", "$scope", "$state", "LocalStorage", "QueryService", "SweetAlert", "CONSTANTS"];

  function LoginController($window, $scope, $state, LocalStorage, QueryService, SweetAlert, CONSTANTS)
  {
    // 'controller as'
    var self = this;
