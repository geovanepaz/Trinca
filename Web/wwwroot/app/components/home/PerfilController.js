...
(function ()
{
  ...
  PerfilController.$inject = ["$window", "$scope", "$compile", "$state", "LocalStorage", "QueryService", "SweetAlert", "CONSTANTS"];

  function PerfilController($window, $scope, $compile, $state, LocalStorage, QueryService, SweetAlert, CONSTANTS)
  {
    // 'controller as'
    var self = this;
    ...
    self.planos = {};
    self.planoSelecionado = LocalStorage.get("planoselecionado");
        ...
        QueryService
          ...
          .then(function (d)
          {
            ...
            if (d.Sucesso)
            {
              ...
              SweetAlert.success("Tudo certo! O Instagram permitiu o acesso à sua conta.", { title: "Perfeito!" }).then(function ()
              {
                self.validarLogin('', true);
              });
            ...
            else
            {
              ...
              {
                var mensagem = `<br><br><a href="${window.location.href}" ng-click="home.validarLogin('',true)">Quer solicitar um novo código?</a>`;
    ...
    self.validarLogin = function (form, fastPass)
    {
      swal.close();
      modalChallenge(true);
        ...
        QueryService
          ...
          .then(function (d)
          {
            ...
            else
            {
              ...
              LocalStorage.remove("autenticacao");
              LocalStorage.remove("pagamento");
              LocalStorage.remove("planoselecionado");
