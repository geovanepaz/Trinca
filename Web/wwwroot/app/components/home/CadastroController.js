...
(function ()
{
  ...
  CadastroController.$inject = ["$window", "$scope", "$state", "LocalStorage", "QueryService", "SweetAlert", "CONSTANTS"];

  function CadastroController($window, $scope, $state, LocalStorage, QueryService, SweetAlert, CONSTANTS)
  {
    // 'controller as'
    var self = this;
