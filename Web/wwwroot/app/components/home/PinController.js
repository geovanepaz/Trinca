...
(function ()
{
  ...
  PinController.$inject = ["$window", "$scope", "$state", "LocalStorage", "QueryService", "SweetAlert", "CONSTANTS"];

  function PinController($window, $scope, $state, LocalStorage, QueryService, SweetAlert, CONSTANTS)
  {
    // 'controller as'
    var self = this;
